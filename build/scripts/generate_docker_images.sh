...
git clone -b "v${VPN_VERSION}" https://github.com/cryptomental/DNP_VPN
...
git clone -b "v${IPFS_VERSION}" https://github.com/cryptomental/DNP_IPFS
...
git clone -b "v${ETHCHAIN_VERSION}" https://github.com/cryptomental/DNP_ETHCHAIN
...
git clone -b "v${ETHFORWARD_VERSION}" https://github.com/cryptomental/DNP_ETHFORWARD
...
git clone -b "v${BIND_VERSION}" https://github.com/cryptomental/DNP_BIND
...
git clone -b "v${WAMP_VERSION}" https://github.com/cryptomental/DNP_WAMP
...
git clone -b "v${DAPPMANAGER_VERSION}" https://github.com/cryptomental/DNP_DAPPMANAGER
...
git clone -b "v${ADMIN_VERSION}" https://github.com/cryptomental/DNP_ADMIN
